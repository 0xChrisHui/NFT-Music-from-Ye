...
- [ ] DraftCard 铸造按钮 + jam-source mintScore + useMintScore hook

### 步骤 5：Track A 剩余 + D2 + E4 + E5 收口

详细见各 track 文件。

### 步骤 6：B7 端到端冒烟（最后做，2026-05-04 调整）

- [ ] **Q3 待答**：smoke test 清单来源（沿用 P5 / 新建 P6 版本，推荐 P6）
- [ ] 跑核心场景 10+ 条（登录/收藏/录制/铸造/分享/移动端/未登录 + B6 5 球 + B3 草稿铸造）
- [ ] 产出 bug 清单 → `reviews/2026-05-XX-phase-6-completion-smoke-test.md`
- [ ] 直接进 Phase 6 completion review
...
**v2 缩减后：~20 step / 覆盖 29 个 findings**（Track B 13→7 / 其他 4 track 不变；见 `reviews/2026-04-25-phase-1-4-strict-cto-review.md` + `reviews/2026-04-25-phase-5-strict-cto-review.md`）
