...
B1 / B3 / B4 / B5 / B6 / B7 与"等 stakeholder 反馈"无关，可立即开工。
...
- 中间 B7 的 bug 清单会被 B2/B3/B4/B5/A 后续修复过期（"测-修-重测"循环）
...
| [B4](#step-b4--音频叠加修复-bug-1) | #29 | 快速连点岛屿不叠加 | 2-3 小时 | 无 |
...
| [**B7**](#step-b7--端到端冒烟--bug-清单产出) | — | 端到端冒烟 + bug 清单产出 | 半天-1天 | **放最后**（依赖 B2/B3/B4/B5 + Track A 全部完成；2026-05-04 调整）|
...
- [ ] 7 steps 全绿（B1 + B2 + B3 + B4 + B5 + B6 + B7）
