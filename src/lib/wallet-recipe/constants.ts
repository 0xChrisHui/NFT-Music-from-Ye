...
export const RECIPE_CROSSFADE_MS_V1 = 60;
...
export const POND_ECHO_COLLECTION_DESCRIPTION =
  'A permanent wallet-born score from Ripples in the Pond, composed from a deterministic 36-part recipe.';
export const POND_ECHO_COLLECTION_EXTERNAL_LINK = 'https://pond-ripple.xyz';
